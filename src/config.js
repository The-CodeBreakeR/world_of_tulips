...
export const CONTRACT_ADDRESS = '0xD6519a91aF49F83ddf07057B6C916872f84abae4'
...
export const WORLD_OF_TULIPS_ABI = [
  {
    ...
    },
    {
      ...
      "name": "getAllOwnedOpenRequestIDs",
      "outputs": [
        {
          "internalType": "uint256[]",
          "name": "openRequestIDs",
